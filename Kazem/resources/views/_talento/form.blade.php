                ...
                <div class="tab-content container">
                    <div class="row">
                        ...
                        <div class="mb-3 col-6">
                            ...
                            <input class="form-control" id="nome" name="nome" required type="text" placeholder="Nome do Talento" value="{{ $model->nome }}">
                        </div>

                        <div class="mb-3 col-6">
                            <label class="form-label" for="pre_requisito">Pré-Requisito: </label>
                            <input class="form-control" id="pre_requisito" name="pre_requisito" type="text" placeholder="Pré-Requistos" value="{{ $model->pre_requisito }}">
                        </div>
