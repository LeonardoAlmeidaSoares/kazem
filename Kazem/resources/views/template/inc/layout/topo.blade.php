...
<ul class="navbar-nav align-items-center d-none d-lg-block">
  <li class="nav-item">
    <div class="search-box" data-list='{"valueNames":["title"]}'>
      <form class="position-relative" data-bs-toggle="search" data-bs-display="static" method="POST" action="{{ url("busca") }}">
        @csrf
        <input class="form-control search-input fuzzy-search" type="search" name="busca" placeholder="Buscar..." aria-label="Buscar" />
        <span class="fas fa-search search-box-icon"></span>

      </form>
      <div class="btn-close-falcon-container position-absolute end-0 top-50 translate-middle shadow-none" data-bs-dismiss="buscar">
